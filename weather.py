...
def Temp_Response():
    ...
    return "temperature is {} degree celsius".format(current_temperature_celsius),"Now, temperature is {} degree celsius, feels like {} degree celsius, minimum temperature is {} , maximum temperature is {}, with {} , wind speed is {} kilometers per hour and in direction of {} degrees".format(current_temperature_celsius,feel,temp_min,temp_max,weather,wind_speed,wind_deg)